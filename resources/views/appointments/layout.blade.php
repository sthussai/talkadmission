    ...
    <x-slot name="body">
        ...
        <div class="max-w-7xl p-12 m-8 bg-white text-gray-900  overflow-hidden shadow-sm sm:rounded-lg">
            <div class="w3-center w3-large w3-bar w3-padding">
                <a class="w3-button w3-round w3-dark-grey" href="/appointments">Home</a>
                <a class="w3-button w3-round w3-dark-grey" href="/appointments/create">Create New Appointment</a>
            </div>
            @yield('content1')
        </div>
