...
<body class="antialiased">
        ...
        <div id='navbar' class="">
            <div class="hidden fixed top-0 left-0 px-6 py-4 sm:block" style="z-index: 2;">Talk Admissions
                </div>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="text-center">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Upcoming medical school interviews?</h1>
            ...
            <a href="#practice" class="text-sm font-semibold leading-6 text-gray-900">Learn more <span aria-hidden="true">→</span></a>
            </div>
        </div>
        </div>
    ...
    <section id="practice" class="bg-white dark:bg-gray-900 mt-24">
        <div class="container px-6 py-10 mx-auto">
            ...
            <div class="mt-8 lg:-mx-6 lg:flex lg:items-center">
                <img class="object-cover w-full lg:mx-6 lg:w-1/2 rounded-xl h-72 lg:h-96" src="https://www.stockvault.net/data/2016/06/23/202936/preview16.jpg"alt="">

                <div  class="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
                <div class="mx-auto max-w-2xl lg:text-center">
                    <p class="my-3 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">PRACTICE WITH CURRENT MEDICAL STUDENTS</p>
                </div>
                    <p class="mt-3 text-2xl text-gray-500 dark:text-gray-300 md:text-xl">
                    The medical school admission process is competitive. The interview can be a daunting hurdle to cross. We offer you the opportunity to connect with current medical students who can give you a running start and help you succeed. 
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:text-center">
        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">CHOOSE THE APPROACH THAT IS</p>
        </div>
        ...
        <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
            ...
            Current students give you the relevant details and share the approaches they used for success. Get help with admission applications or practice for your interviews.  
            </dd>
            </div>
            <div class="relative pl-16">
            <dt class="text-base font-semibold leading-7 text-gray-900">
            ...
            <dd class="mt-2 text-base leading-7 text-gray-600">Practice one on one with students at the school you are looking to interview at. Benefit from their experience and get tailored guidance that sets you up for success.</dd>
            </div>
            <div class="relative pl-16">
            <dt class="text-base font-semibold leading-7 text-gray-900">
                <div class="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
            ...
            <dd class="mt-2 text-base leading-7 text-gray-600">Students can provide cost-effective guidance and mentorship without compromising on quality. Get the advice and practice you need while staying within your budget.</dd>
            </div>
        </dl>
        </div>
    ...
    <!-- Left: Image -->
        <div class="w-1/2 h-screen hidden lg:block md:block relative text-center">
            
        <img src="https://cdn.pixabay.com/photo/2013/10/02/23/03/mountains-190055_1280.jpg" alt="Placeholder Image" class="object-cover w-full h-full">
        <h1 class=" backdrop-blur-xl p-10 rounded-3xl absolute text-4xl font-semibold text-white dark:text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
            Motivations and Rationale</h1>
    </div>
        <!-- Right: Text -->
        <div class="lg:p-20 md:p-10 sm:20 p-8 w-full lg:w-1/2 md:w-1/2">
                                ...
                                <div class="md:flex md:items-start md:-mx-4">
                                    ...
                                    <div class="mt-4 md:mx-4 md:mt-0">
                                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Price control</h1>
                            ...
                            Current pre-admission markets are unregulated and competitive. Hence prices can be exorbitantly high for admission prep and interview training. We’re motivated to bring them back down to reason.
                                ...
                                <div class="md:flex md:items-start md:-mx-4">
                                    ...
                                    <div class="mt-4 md:mx-4 md:mt-0">
                                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Variable needs</h1>
                            ...
                            Some students can benefit a lot from interview practice. Some may only need a little help. Some are already ready and could just use the reassurance. Paying hundreds of dollars for the average interview prep plan available in the current market is not the solution for all. 
                                ...
                                <div class="md:flex md:items-start md:-mx-4">
                                    ...
                                    <div class="mt-4 md:mx-4 md:mt-0">
                                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Indeterminate impact</h1>
    ...
    <div class="m-10 mx-auto p-16 sm:p-24 lg:p-48 bg-gray-200">
        ...
        <div class="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg" style="min-height: 19rem;">
            <img class="absolute inset-0 w-full h-full object-cover object-center" src="https://www.stockvault.net/data/2016/10/31/215073/preview16.jpg" alt="">
      ...
      <p class="font-sans text-lg text-black">                            We control costs without compromising on quality. We’re driven to help you get exceptional value for your money.</p>    
    ...
    '        <div class="mx-auto max-w-2xl lg:text-center">
                <p class="mb-6 text-3xl font-bold tracking-tight uppercase text-gray-900 sm:text-4xl">Choose what you need</p>
                </div>
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4 md:grid-cols-2">
            ...
            <p class="mt-4 text-lg text-slate-600">Get guidance from medical students on developing an approach to answering various MMI questions</p>

            <div class="mt-12 flex transform items-center justify-center transition-transform duration-150 ease-in-out hover:scale-125">
        <svg width="156px" height="156px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M512 960c-92.8 0-160-200-160-448S419.2 64 512 64s160 200 160 448-67.2 448-160 448z m0-32c65.6 0 128-185.6 128-416S577.6 96 512 96s-128 185.6-128 416 62.4 416 128 416z" fill="#050D42"></path><path d="M124.8 736c-48-80 92.8-238.4 307.2-363.2S852.8 208 899.2 288 806.4 526.4 592 651.2 171.2 816 124.8 736z m27.2-16c33.6 57.6 225.6 17.6 424-97.6S905.6 361.6 872 304 646.4 286.4 448 401.6 118.4 662.4 152 720z" fill="#050D42"></path><path d="M899.2 736c-46.4 80-254.4 38.4-467.2-84.8S76.8 368 124.8 288s254.4-38.4 467.2 84.8S947.2 656 899.2 736z m-27.2-16c33.6-57.6-97.6-203.2-296-318.4S184 246.4 152 304 249.6 507.2 448 622.4s392 155.2 424 97.6z" fill="#050D42"></path><path d="M512 592c-44.8 0-80-35.2-80-80s35.2-80 80-80 80 35.2 80 80-35.2 80-80 80zM272 312c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48zM416 880c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48z m448-432c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48z" fill="#ec4899"></path></g></svg>
            </div>
            </div>
            ...
            <p class="mt-4 text-lg text-slate-600">Learn tips and tricks for approaching traditional interview stations that typically involve multiple interviewers</p>

            
            <div class="mt-12 flex transform items-center justify-center transition-transform duration-150 ease-in-out hover:scale-125">
        <svg width="156px" height="156px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M512 960c-92.8 0-160-200-160-448S419.2 64 512 64s160 200 160 448-67.2 448-160 448z m0-32c65.6 0 128-185.6 128-416S577.6 96 512 96s-128 185.6-128 416 62.4 416 128 416z" fill="#050D42"></path><path d="M124.8 736c-48-80 92.8-238.4 307.2-363.2S852.8 208 899.2 288 806.4 526.4 592 651.2 171.2 816 124.8 736z m27.2-16c33.6 57.6 225.6 17.6 424-97.6S905.6 361.6 872 304 646.4 286.4 448 401.6 118.4 662.4 152 720z" fill="#050D42"></path><path d="M899.2 736c-46.4 80-254.4 38.4-467.2-84.8S76.8 368 124.8 288s254.4-38.4 467.2 84.8S947.2 656 899.2 736z m-27.2-16c33.6-57.6-97.6-203.2-296-318.4S184 246.4 152 304 249.6 507.2 448 622.4s392 155.2 424 97.6z" fill="#050D42"></path><path d="M512 592c-44.8 0-80-35.2-80-80s35.2-80 80-80 80 35.2 80 80-35.2 80-80 80zM272 312c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48zM416 880c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48z m448-432c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48z" fill="#22c55e"></path></g></svg>
            </div>
            ...
            <p class="mt-4 text-lg text-slate-600">Get personalized suggestions on your CV and application to maximize your chances for that interview </p>

            
            <div class="mt-12 flex transform items-center justify-center transition-transform duration-150 ease-in-out hover:scale-125">
        <svg width="156px" height="156px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M512 960c-92.8 0-160-200-160-448S419.2 64 512 64s160 200 160 448-67.2 448-160 448z m0-32c65.6 0 128-185.6 128-416S577.6 96 512 96s-128 185.6-128 416 62.4 416 128 416z" fill="#050D42"></path><path d="M124.8 736c-48-80 92.8-238.4 307.2-363.2S852.8 208 899.2 288 806.4 526.4 592 651.2 171.2 816 124.8 736z m27.2-16c33.6 57.6 225.6 17.6 424-97.6S905.6 361.6 872 304 646.4 286.4 448 401.6 118.4 662.4 152 720z" fill="#050D42"></path><path d="M899.2 736c-46.4 80-254.4 38.4-467.2-84.8S76.8 368 124.8 288s254.4-38.4 467.2 84.8S947.2 656 899.2 736z m-27.2-16c33.6-57.6-97.6-203.2-296-318.4S184 246.4 152 304 249.6 507.2 448 622.4s392 155.2 424 97.6z" fill="#050D42"></path><path d="M512 592c-44.8 0-80-35.2-80-80s35.2-80 80-80 80 35.2 80 80-35.2 80-80 80zM272 312c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48zM416 880c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48z m448-432c-27.2 0-48-20.8-48-48s20.8-48 48-48 48 20.8 48 48-20.8 48-48 48z" fill="#a855f7"></path></g></svg>
            </div>
...
'    </div>
    ...
    <!-- Mentor/mentee START -->
    <div id="signup" class="flex flex-col bg-white py-4 px-12">
        <div class="py-4">
            <div class="pl-[116px] pr-[205px] py-8">
                <div class="text-4xl text-black">Mentor or mentee?</div>
                <div class="py-3 lead-xl font-light ">We're looking for amazing medical students to help their future colleagues across the finish line </div>
            </div>
        </div>
        <div class="flex flex-col px-20 md:px-10 md:flex-row items-center justify-center gap-6">
        <div>
            <img src="https://cdn.pixabay.com/photo/2019/08/14/09/53/consulting-4405260_1280.jpg" alt="Featured Image 1" class="rounded-t-xl"/>
            <div class="px-9 pt-10 pb-14 bg-blue-950 rounded-b-lg">
                <div class="text-white space-y-4">
                    ...
                    <div class="text-lg font-light">Join as a mentor to share your experience with your future colleagues
                    </div>
                </div>
                <div class="flex justify-between pt-8">
                    
                    <div class="flex flex-col justify-end">
                        <a href="#" class="py-3 px-6 bg-white text-primary-200 paragraph-m  rounded-full">Sign Up</a>
                    </div>
                </div>
            </div>
        </div> 
        <div class="">
            <img src="https://cdn.pixabay.com/photo/2016/02/07/21/03/computer-1185626_1280.jpg" alt="Featured Image 1" class="rounded-t-xl"/>
            <div class="px-9 pt-10 pb-14 bg-violet-600 rounded-b-lg">
                <div class="text-white space-y-4">
                    ...
                    <div class="text-lg font-light">Join as an applicant and connect with current medical students </div>
                </div>
                <div class="flex justify-between pt-8">
       ...
       <div
          ...
          >
            ...
            >
              ...
              > Get<span class="bg-clip-text text-transparent bg-gradient-to-r from-teal-500 via-cyon-400 to-purple-300"> in touch!</span> </span>
            </h1>
            <div
